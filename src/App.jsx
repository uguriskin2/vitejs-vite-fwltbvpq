      ...
      <main className="max-w-6xl w-full mx-auto p-4 md:p-8 flex-1">
        {view === 'landing' && (
          <div className="text-center py-10 sm:py-20 animate-in fade-in zoom-in print:hidden px-4">
            ...
            <p className="text-sm sm:text-lg md:text-xl text-slate-400 mb-10 sm:mb-14 max-w-2xl mx-auto font-bold leading-relaxed px-4">Sınavınızda Başarılar Dilerim.Uğur ISKIN(Bilgisayar Öğretmeni)</p>
